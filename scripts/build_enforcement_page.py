...
<p class="lead">Citations cluster in a handful of large, heavily-used parks, mostly ones without a nearby legal off-leash area, while resident complaints concentrate somewhere else entirely. This section maps both: the citation hotspots and their pre/post-COVID persistence, the half-mile walkshed gaps, and the full per-park table. Throughout, the records show <em>where</em> citations were issued, not <em>why</em> officers were there.</p>
