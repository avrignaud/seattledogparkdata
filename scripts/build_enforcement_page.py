...
<div class="gap-callout" id="gap">
  ...
  <p>Citation counts measure <em>enforcement activity</em>, not underlying violation rates. A drop in citations could mean fewer violations <em>or</em> fewer patrols. SPR's 2015 <em>People, Dogs and Parks</em> owner survey found about 38% of dog owners admit illegal off-leash use; <strong>no follow-up survey has been published.</strong> The 2026 staffing expansion is being implemented without a publicly-released review of the 2016 expansion's effect on behavior. Pending public-records requests that would help close these gaps:</p>
  <ul>
